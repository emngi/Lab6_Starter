...
function getRecipesFromStorage() {
	...
	return recipesList == null ? [] : JSON.parse(recipesList);
}
...
function initFormHandler() {
	...
	formEl.addEventListener("submit", (event) => {
	  ...
	  // Create an empty object (we'll refer to this object as recipeObject to
	...
	let clearEl = document.querySelector(".danger");
